...
export const DEFAULT_USER_IMAGE_URL = '/avatars/original/missing.png'
...
export const ADD_BAND_IMAGE = 'ADD_BAND_IMAGE'
export const DEFAULT_BAND_IMAGE_URL = '/images/original/missing.png'
